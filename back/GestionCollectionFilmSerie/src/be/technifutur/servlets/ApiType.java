...
@WebServlet(name = "ApiType", urlPatterns = { "/apiType" })
public class ApiType extends HttpServlet {
	TypeService typeService = new TypeService();

	@Override
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		try {
			Util.formatResponse(resp, typeService.selectAll(ConnexionPSQL.getInstance()));
